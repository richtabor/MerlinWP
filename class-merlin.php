...
class Merlin {
	...
	public function add_admin_menu() {
		...
		$this->hook_suffix = add_submenu_page(
			esc_html( $admin_menu_args['parent_slug'] ), esc_html( $strings['admin-menu'] ), esc_html( $strings['admin-menu'] ), sanitize_key( $this->capablility ), sanitize_key( $this->merlin_url ), array( $this, 'admin_page' )
		);
	}
