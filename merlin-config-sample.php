...
$wizard = new Merlin(
	...
	$strings = array(
		...
		'license-link-1'            	=> wp_kses( sprintf( __( '<a href="https://wordpress.org/support/" target="_blank">%s</a>', '@@textdomain' ), esc_html__( 'Explore WordPress', '@@textdomain' ) ), array( 'a' => array( 'href' => array(), 'target' => array() ) ) ),
		'license-link-2'            	=> wp_kses( sprintf( __( '<a href="https://themebeans.com/contact/" target="_blank">%s</a>', '@@textdomain' ), esc_html__( 'Get Theme Support', '@@textdomain' ) ), array( 'a' => array( 'href' => array(), 'target' => array() ) ) ),
		'license-link-3'           	=> wp_kses( sprintf( __( '<a href="'.admin_url( 'customize.php' ).'" target="_blank">%s</a>', '@@textdomain' ), esc_html__( 'Start Customizing', '@@textdomain' ) ), array( 'a' => array( 'href' => array(), 'target' => array() ) ) ),
		...
		'ready-link-1'              	=> wp_kses( sprintf( __( '<a href="https://wordpress.org/support/" target="_blank">%s</a>', '@@textdomain' ), esc_html__( 'Explore WordPress', '@@textdomain' ) ), array( 'a' => array( 'href' => array(), 'target' => array() ) ) ),
		'ready-link-2'              	=> wp_kses( sprintf( __( '<a href="https://themebeans.com/contact/" target="_blank">%s</a>', '@@textdomain' ), esc_html__( 'Get Theme Support', '@@textdomain' ) ), array( 'a' => array( 'href' => array(), 'target' => array() ) ) ),
		'ready-link-3'             	=> wp_kses( sprintf( __( '<a href="'.admin_url( 'customize.php' ).'" target="_blank">%s</a>', '@@textdomain' ), esc_html__( 'Start Customizing', '@@textdomain' ) ), array( 'a' => array( 'href' => array(), 'target' => array() ) ) ),
	)
);
